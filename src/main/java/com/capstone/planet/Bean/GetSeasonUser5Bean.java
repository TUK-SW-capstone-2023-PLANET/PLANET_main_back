...
@Component
public class GetSeasonUser5Bean {
    ...
    @Autowired
    public GetSeasonUser5Bean(GetUserDAOBean getUserDAOBean, GetSeasonUserDAOBean getSeasonUserDAOBean, CreateSeasonUserDTOBean createSeasonUserDTOBean) {
    ...
    public List<Map<Integer, ResponseSeasonUserGetDTO>> exec(Long userId) {
        ...
        return createSeasonUserDTOBean.exec("check", userDAO, seasonDAOS);
    }
}

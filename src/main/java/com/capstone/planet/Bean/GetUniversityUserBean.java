...
public class GetUniversityUserBean {
    ...
    @Autowired
    public GetUniversityUserBean(GetUserDAOBean getUserDAOBean, CreateUniversityUserDTOBean createUniversityUserDTOBean) {
    ...
    public List<Map<Integer, ResponseUserUniversityGetDTO>> exec(Long userId){
        ...
        // 반환 객체 만들기
        return createUniversityUserDTOBean.exec(userDAO, userDAOS);
    }
}
